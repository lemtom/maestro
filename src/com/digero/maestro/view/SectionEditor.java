...
public class SectionEditor {
	...
	public static void show(JFrame jf, NoteGraph noteGraph, AbcPart abcPart, int track) {
		...
		class SectionDialog extends JDialog {
			...
			private final double[] LAYOUT_COLS = new double[] { 0.25,0.25,0.25,0.25 };
		    ...
		    public SectionDialog(JFrame jf, NoteGraph noteGraph, String title, boolean modal, AbcPart abcPart, int track) {
		        ...
		        panel.add(new JLabel(abcPart.getTitle()+": "+abcPart.getInstrument().toString()+" on track "+track), "0, 0, 3, 0, C, C");
		        ...
		        panel.add(okButton, "3,9,f,f");
		        panel.add(new JLabel("Enabled sections must be chronological and no overlap."), "0, 11, 3, 11, c, c");
		        panel.add(new JLabel("Bar numbers are inclusive and use original meter."), "0, 12, 3, 12, c, c");
